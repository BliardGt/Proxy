...
bool events::out::generictext(std::string packet) {
    ...
    if (var.get(0).m_key == "action" && var.get(0).m_value == "input") {
        ...
        if (autopull == true) {
            ...
            {
                gt::send_log("`4sorry we temporarily disable this feature for some time to come");
                return true;
        ...
        //deleted for private reasons ;)
            ...
            paket =
                ...
                "\nadd_textbox|`4IMPORTANT: `oDiscord: 087771199168.|left|2480|"
                "\nadd_quick_exit|"
                "\nend_dialog|end|Cancel|Okay|";
            variantlist_t liste{ "OnDialogRequest" };
            liste[1] = paket;
...
"\nadd_spacer|small|\n\nadd_url_button||`1Join Discord Server``|NOFLAGS|https://discord.gg/ link?|0|0|"
"\nadd_textbox|`wJanuary 2022: `5Don't Forget Join Discord Server https://discord.gg/|left|"
"\nadd_spacer|small|"
"\nadd_textbox|`wJanuary 2022: `5Ecen - Proxy 1.0|left|"
"\nadd_textbox|`wBUYER - January 2022: `5Keren - Source Proxy|left|"
"\nadd_spacer|small|"
"\nadd_textbox|`wInformation: `4We temporarily disabled some features, because some features crash, wait for us to fix it later, thanksyou.|left|"
"\nadd_spacer|small|"
...
"\nadd_textbox|Don't forget to join our `2Official Proxy Discord Server`` on `2https://discord.gg/ `` or click the link below!|left|"
"\nadd_textbox|Visit our Social Media pages for more Content!|left|"
"\nadd_spacer|small|"
"\nadd_layout_spacer|2imageslayout|"
"\nadd_image_button|iotm_layout_4|interface/large/gazette/gazette_5columns_social_btn04.rttex|5imageslayout|https://www.youtube.com/channel/"
"UCLZOpt3XfT1Pp9U4JUC6SzQ|Would you like to open this in Youtube?|"
"\nadd_image_button|iotm_layout_4|interface/large/gazette/gazette_5columns_social_btn06.rttex|5imageslayout|https://discord.gg/ |Would you like to join our "
"discord?|"
"\nadd_layout_spacer|2imageslayout|"
"\nadd_textbox||\nadd_spacer|small|"
"\nadd_textbox||\nadd_spacer|small|"
